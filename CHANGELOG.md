...
##### &nbsp;&nbsp;&nbsp;&nbsp;[View changes on GitHub](https://github.com/barathrajd/task-tracker-nodejs/compare/0.0.2-beta.10...0.0.2-beta.11)
...
- Add lint script using Biome and update package version to 0.0.2-beta.8. &nbsp;-&nbsp; by **barathrajd** [<samp>(6ff1c)</samp>](https://github.com/barathrajd/task-tracker-nodejs/commit/6ff1c98)

##### &nbsp;&nbsp;&nbsp;&nbsp;[View changes on GitHub](https://github.com/barathrajd/task-tracker-nodejs/compare/0.0.2-beta.6...0.0.2-beta.9)
...
##### &nbsp;&nbsp;&nbsp;&nbsp;[View changes on GitHub](https://github.com/barathrajd/task-tracker-nodejs/compare/0.0.2-beta.6...0.0.2-beta.7)
...
- Bump version to 0.0.2-beta.4 and update changelog with new features and bug fixes. &nbsp;-&nbsp; by **barathrajd** [<samp>(bcc02)</samp>](https://github.com/barathrajd/task-tracker-nodejs/commit/bcc02e1)
- Bump version to 0.0.2-beta.5 and update changelog with new features and bug fixes. &nbsp;-&nbsp; by **barathrajd** [<samp>(beb24)</samp>](https://github.com/barathrajd/task-tracker-nodejs/commit/beb245d)
...
##### &nbsp;&nbsp;&nbsp;&nbsp;[View changes on GitHub](https://github.com/barathrajd/task-tracker-nodejs/compare/0.0.1...0.0.2-beta.6)
...
##### &nbsp;&nbsp;&nbsp;&nbsp;[View changes on GitHub](https://github.com/barathrajd/task-tracker-nodejs/compare/0.0.1...0.0.2-beta.5)
...
##### &nbsp;&nbsp;&nbsp;&nbsp;[View changes on GitHub](https://github.com/barathrajd/task-tracker-nodejs/compare/0.0.1...0.0.2-beta.3)
...
* Add project metadata and configure conventional changelog generation. ([afceb32](https://github.com/barathrajd/task-tracker-nodejs/commit/afceb32df174136d3b1c4708df454a428cc742ce))
* Add release-it configuration and dependencies for automated releases. ([99ba0f6](https://github.com/barathrajd/task-tracker-nodejs/commit/99ba0f6f8935776d8f543af96afc81d2b7accbde))
